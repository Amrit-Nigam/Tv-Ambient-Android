...
object Palette {
    ...
    // Backgrounds (night — even darker, lower luminance)
    val NightInk = Color(0xFF060809)
    val NightRaised = Color(0xFF0C1014)
    ...
    // Night text (lower luminance to reduce glare in a dark room)
    val NightTextHi = Color(0xFFC7CDD1)
    val NightTextMid = Color(0xFF7E878D)
}
