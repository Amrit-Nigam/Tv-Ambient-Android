...
// ---- Secrets are read from a gitignored secrets.properties, never hardcoded. ----
// See secrets.properties.example for the expected keys. Missing values fall back to "".
...
android {
    namespace = "com.tvport.dashboard"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.tvport.dashboard"
        minSdk = 21
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"

        // Injected at build time from secrets.properties (gitignored). Never committed.
